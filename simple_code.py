...
# Clean sequence and validate input
    ...
    if len(dna_sequence) % 3 != 0:
        print("Warning: DNA sequence length is not a multiple of 3. Truncating the remainder.")
...
#Hamming Distance between Slack and Twitter/X name
...
#Surprise Task
#Gene Expression Analysis (Heatmap & Volcano Plot)
...
#Gene Expression Analysis(a. Heatmap)
import pandas as pd
...
#Gene Expression Analysis (b. Volcano Plot)
import pandas as pd
import matplotlib.pyplot as plt
import seaborn as sns
import numpy as np
...
#Breast Cancer Exploration (c. Scatter Plot (radius vs texture))
import pandas as pd
import matplotlib.pyplot as plt
...
#Breast Cancer Exploration (d. Correlation Heatmap)
import pandas as pd
import seaborn as sns
import matplotlib.pyplot as plt
...
#Breast Cancer Exploration (e. Scatter Plot (smoothness vs compactness))
import pandas as pd
import seaborn as sns
import matplotlib.pyplot as plt
from google.colab import files
...
#Breast Cancer Exploration (f. Density Plot (area distribution))
import pandas as pd
import seaborn as sns
import matplotlib.pyplot as plt
from google.colab import files
